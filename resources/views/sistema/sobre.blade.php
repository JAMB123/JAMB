    ...
    <div class="row">
        ...
        <div class="col-sm-5" id="sobre">
            <div class="container">
                ...
                <br>
                <p class="h1 text-start" style=" font-size: 40px; margin-left: 30px">O site possui uma seção para anunciar os pets que estão a espera de um lar, clicando na imagem do animal, apresentará mais informações sobre o pet e suas características. Para adotar, basta clicar no botão de “Quero adotar” que o contato do doador estará a mostra para entrar em contato.</p>
